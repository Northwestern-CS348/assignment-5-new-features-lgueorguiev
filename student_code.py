...
def buildFeatureStatement(tree):
    ...
    resolve_obj = core.resolveObjectFOPC(subject_of_verb)
    ...
    core.findAndAttachPrepObjectsFOPC(root, subject_of_verb, resolve_obj)
    ...
    core.findAndAssertFeaturesFOPC(root, resolve_obj)
    core.findAndAssertDefinitionsFOPC(root, resolve_obj)